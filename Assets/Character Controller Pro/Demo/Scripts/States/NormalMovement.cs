...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    public class NormalMovement : CharacterState
    {
        ...
        protected int notGroundedJumpsLeft = 3;
        ...
        public delegate void AchieveDelegate();
        public event AchieveDelegate JumpEvent;
        public event AchieveDelegate JetpackEvent;
        public event AchieveDelegate CreateWallEvent;
        ...
        protected virtual void ProcessRegularJump(float dt)
        {
            ...
            else
            {
                ...
                if (!verticalMovementParameters.canParachute)
                {
                    verticalMovementParameters.canParachute = true;
