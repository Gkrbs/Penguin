...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    {
        [Min(0f)]
        public float baseSpeedLimit = 3f;
        ...
        [Min(0f)]
        public float boostSpeedLimit = 5f;


        [Header("Stable grounded parameters")]
        public float stableGroundedAcceleration = 30f;
        public float stableGroundedDeceleration = 20f;
        ...
        public float unstableGroundedAcceleration = 5f;
        public float unstableGroundedDeceleration = 1f;
        ...
        public float notGroundedAcceleration = 10f;
        public float notGroundedDeceleration = 3f;
    ...
    public class VerticalMovementParameters
    {
        ...
        public float paraSpeed = 3.0f;

        public bool canParachute = false;
        
        public bool parachuting = false;

        [Header("Grapple")]

        public float grappleSpeed = 50.0f;
        ...
        [Min(0f)]
        public float jumpApexHeight = 1.5f;
        ...
        public int availableNotGroundedJumps = 0;
